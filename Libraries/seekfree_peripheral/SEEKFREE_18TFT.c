	...
	if(0==TFT_DISPLAY_DIR || 1==TFT_DISPLAY_DIR)									// 竖屏
	{
		...
		for(j=0;j<coord_y;j++)
		{
			...
			for(i=0;i<coord_x;i++)
			{
				...
				if(j==L_side[i]||j==R_side[i]||j==79&&i<5)
                                {
                                  color=BLUE;
                                }
                                else if(j==mid[i])
                                  color=GRAY;
                                else if(i==LOW||i==LOW+HIGHT)
                                {
                                  color=RED;
                                }
                                else if(temp>Black)
	...
	else																			// 横屏
	{
		...
		for(j=0;j<coord_y;j++)
		{
			for(i=0;i<coord_x;i++)
			{
				...
				if(i==L_side[j]||i==R_side[j]||i==79&&j<5)
                                {
                                  color=BLUE;
                                }
                                else if(i==mid[j])
                                  color=GRAY;
                                else if(j==LOW||j==LOW+HIGHT)
                                {
                                  color=RED;
                                }
                                else if(j==yidong)
...
void lcd_displayimage032_hui(uint8 *p, uint16 width, uint16 height) 
{
        uint32 i,j;
